...
5. **Focus on Best Practices**:
   - Ensure proper use of ownership, traits for abstraction, and module organization
   - Validate CommonJS/ESM module patterns, async patterns, and package boundaries
