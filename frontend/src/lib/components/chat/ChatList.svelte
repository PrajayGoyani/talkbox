  ...
  <div class="mb-2 flex flex-col gap-1.5">
    {#if showRequestInput}
      <div class="flex gap-1.5 items-center">
        ...
        />
        <button
          class="w-10 h-10 flex items-center justify-center rounded-lg text-slate-500 hover:text-indigo-600 transition-colors disabled:opacity-40 active:scale-90"
        ...
        <button
          class="w-10 h-10 flex items-center justify-center rounded-lg text-slate-500 hover:text-rose-500 transition-colors active:scale-90"
          onclick={() => {
            showRequestInput = false;
            requestError = null;
          }}
    ...
    {:else}
      <button
        class="flex items-center justify-center gap-2 w-full p-2.5 border border-dashed border-slate-300 dark:border-white/10 rounded-xl text-slate-500 hover:text-indigo-600 hover:border-indigo-500 hover:bg-indigo-500/5 transition-all text-sm font-medium active:scale-[0.98]"
