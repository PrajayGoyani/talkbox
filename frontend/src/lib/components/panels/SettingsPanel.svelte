...
<div class="h-full flex flex-col">
  ...
  <div class="p-4 flex flex-col gap-3 overflow-y-auto">
    ...
    >
      ...
      <button
        type="button"
        class="relative inline-flex h-6 w-11 shrink-0 rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2 {currentTheme ===
        'dark'
          ? 'bg-indigo-600'
          : 'bg-slate-400'}"
        onclick={toggleTheme}
