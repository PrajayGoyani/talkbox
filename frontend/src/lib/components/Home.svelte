  ...
  <main>
    ...
    <section class="max-w-7xl mx-auto px-4 text-center">
      ...
      <p class="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto mb-10">
        Experience seamless, real-time messaging with a premium interface designed for modern teams and individuals.
      </p>
              ...
              {#each [1, 2, 3, 4] as i}
                <div class="flex gap-3 items-center opacity-70">
                  ...
                  <div class="space-y-2 flex-1">
                    <div class="w-3/4 h-3 bg-slate-100 dark:bg-slate-800 rounded"></div>
                    <div class="w-1/2 h-2 bg-slate-50 dark:bg-slate-900 rounded"></div>
                  </div>
                </div>
              {/each}
            </div>
    ...
    <!-- Features Section -->
    <section id="features" class="py-32 bg-slate-100/50 dark:bg-slate-950/50 mt-32">
       <div class="max-w-7xl mx-auto px-4">
         ...
         <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
           <!-- Feature 1 -->
           <div class="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-xl transition-all hover:-translate-y-2">
             <div class="w-12 h-12 bg-indigo-100 dark:bg-indigo-900/50 text-indigo-600 dark:text-indigo-400 rounded-2xl flex items-center justify-center mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
             </div>
             <h3 class="text-xl font-bold mb-2">Real-time Sync</h3>
             <p class="text-slate-600 dark:text-slate-400">Messages delivered across all devices in under 100ms. Stay in the loop, always.</p>
           </div>
           ...
           <div class="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-xl transition-all hover:-translate-y-2">
             ...
             <p class="text-slate-600 dark:text-slate-400">Your data is encrypted and secure. We prioritize your privacy above all else.</p>
           </div>

           <!-- Feature 3 -->
           <div class="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-xl transition-all hover:-translate-y-2">
             <div class="w-12 h-12 bg-emerald-100 dark:bg-emerald-900/50 text-emerald-600 dark:text-emerald-400 rounded-2xl flex items-center justify-center mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
             ...
             <p class="text-slate-600 dark:text-slate-400">Manage all your conversations, settings, and profile from one gorgeous interface.</p>
           </div>
         </div>
       </div>
    </section>
    ...
    <section id="faq" class="py-32 max-w-4xl mx-auto px-4">
      <h2 class="text-3xl md:text-5xl font-bold text-center mb-16">Common Questions</h2>
      <div class="space-y-4">
        <details class="group bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-6 overflow-hidden transition-all">
          <summary class="list-none cursor-pointer flex items-center justify-between font-bold text-lg">
          ...
          <div class="mt-4 pt-4 border-t border-slate-100 dark:border-slate-800 text-slate-600 dark:text-slate-400">
            Yes, Talkbox offers a robust free tier for individual users. Premium features for teams are coming soon.
          </div>
        </details>
        ...
        <details class="group bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-6 overflow-hidden transition-all">
          ...
          <div class="mt-4 pt-4 border-t border-slate-100 dark:border-slate-800 text-slate-600 dark:text-slate-400">
            Absolutely. Your messages sync instantly across desktop and mobile browsers.
          </div>
        </details>
        ...
        <details class="group bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-6 overflow-hidden transition-all">
          ...
          <div class="mt-4 pt-4 border-t border-slate-100 dark:border-slate-800 text-slate-600 dark:text-slate-400">
            We use industry-standard encryption protocols and never sell your personal information.
          </div>
        </details>
      </div>
    </section>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        <div class="col-span-1 md:col-span-2">
          ...
          <p class="text-slate-600 dark:text-slate-400 max-w-sm">
            Building the future of digital communication. Fast, secure, and beautiful - just like your best conversations.
          </p>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-4 text-sm text-slate-600 dark:text-slate-400">
            <li><button onclick={() => routerStore.navigate(Route.TERMS)} class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Terms of Use</button></li>
            <li><button onclick={() => routerStore.navigate(Route.PRIVACY)} class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Privacy Policy</button></li>
            <li><button onclick={() => routerStore.navigate(Route.PRIVACY)} class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Cookie Policy</button></li>
          </ul>
        </div>
        ...
        <div>
           ...
           <ul class="space-y-4 text-sm text-slate-600 dark:text-slate-400">
             {#if authStore.user}
               <li><button onclick={() => routerStore.navigate(dashboardLink)} class="hover:text-indigo-600 dark:hover:text-indigo-400">Dashboard</button></li>
             {:else}
               <li><button onclick={() => routerStore.navigate(loginLink)} class="hover:text-indigo-600 dark:hover:text-indigo-400">Sign In</button></li>
               <li><button onclick={() => routerStore.navigate(signupLink)} class="hover:text-indigo-600 dark:hover:text-indigo-400">Sign Up</button></li>
             {/if}
           </ul>
        </div>
      </div>

      <div class="pt-8 border-t border-slate-200 dark:border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500">
        <p>© 2026 Talkbox — Crafted with love for real people.</p>
        <div class="bg-indigo-600/5 dark:bg-indigo-600/10 px-4 py-2 rounded-full border border-indigo-600/10 flex items-center gap-2">
...
<style>
  ...
  .rotate-x-6 {
    --tw-rotate-x: 6deg;
    transform: translate3d(var(--tw-translate-x), var(--tw-translate-y), var(--tw-translate-z)) rotate(var(--tw-rotate)) rotateX(var(--tw-rotate-x)) rotateY(var(--tw-rotate-y)) rotateZ(var(--tw-rotate-z)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
  }
